...
class Cliente extends ModeloBase {
    ...
    public function generarPagosMensuales($mes, $anio, $monto) {
        ...
        $fecha_vencimiento = date('Y-m-d', strtotime("{$anio}-{$mes}-10"));
        $creados = 0;
        ...
        foreach ($clientes as $cliente) {
            ...
            if ($existe == 0) {
                $sql_insert = "INSERT INTO pagos (cliente_id, mes, anio, monto, fecha_vencimiento, estado) 
                              VALUES (:cliente_id, :mes, :anio, :monto, :fecha_vencimiento, 'pendiente')";
